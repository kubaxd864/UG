...
export default async function PokemonPage({ params }) {
  ...
  return (
    <main className="flex flex-col justify-center w-[80%] rounded-2xl bg-zinc-900 p-5 gap-5">
      <div className="flex flex-row justify-center gap-5">
        <div className="w-full flex flex-col gap-10">
          <div className="flex flex-row w-full items-center gap-10 rounded-xl bg-zinc-800 p-4">
            <img
